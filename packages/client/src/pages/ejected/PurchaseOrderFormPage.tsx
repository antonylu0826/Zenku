...
export default function PurchaseOrderFormPage({ entityId, onNavigate }: Props) {
    ...
    const { data: existing } = useEntityDetail("purchaseOrder", entityId || "", {
        include: "items"
    });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success(isEdit ? "採購單已更新" : "採購單已建立");
            onNavigate("/purchaseOrder");
        } catch (error: any) {
            console.error("PurchaseOrder save failed:", error);
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Button variant="ghost" onClick={() => onNavigate("/purchaseOrder")}>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <Card>
                    ...
                    <CardContent className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="orderNumber">採購單號</Label>
                            <Input
                                id="orderNumber"
                                value={orderNumber}
                        ...
                        <div className="space-y-2">
                            ...
                            <Select key={`supplier-${supplierId}`} value={supplierId} onValueChange={setSupplierId}>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        <CardTitle className="text-lg">採購項目</CardTitle>
                ...
                <div className="flex justify-end gap-3">
                    <Button type="button" variant="outline" onClick={() => onNavigate("/purchaseOrder")}>
                        取消
                    </Button>
