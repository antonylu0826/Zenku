...
export default defineEntity({
    ...
    relations: {
        salesOrder: { type: 'SalesOrder', field: 'salesOrderId', parentRelation: true, onDelete: 'Cascade' },
        product: { type: 'Product', field: 'productId', lookupField: 'name' },
    },
    access: { all: 'auth() != null' },
    i18n: {
        en: { caption: 'Sales Item', fields: { productId: 'Product', quantity: 'Qty', unitPrice: 'Price', amount: 'Amount' } },
        'zh-TW': { caption: '銷貨明細', fields: { productId: '產品', quantity: '數量', unitPrice: '單價', amount: '小計' } },
    },
})
